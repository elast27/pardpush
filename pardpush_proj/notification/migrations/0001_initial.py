    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ManyToManyField(related_name='interested_students', to='notification.Tag')),
            ],
        ),
        migrations.AddField(
            model_name='event',
        ...
        migrations.AddField(
            model_name='event',
            name='tag',
            field=models.ManyToManyField(related_name='event_tags', to='notification.Tag'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
